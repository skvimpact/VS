/*
drop procedure [dbo].C_GetDims
>>>>>>>>>> Test >>>>>>>>>>
exec [dwh].[C_GetDims] 'TD Investments', 2, 1, 0
exec [dwh].[C_GetDims] 'TD Investments', 2, 1, 1
exec [dwh].[C_GetDims] 'TD Investments', 2, 1, 2
exec [dwh].[C_GetDims] 'TD Investments', 2, 1, 7
exec [dwh].[C_GetDims] 'TD Investments', 2, 1, 9
exec [dwh].[C_GetDims] 'TD Investments', 2, 1, 10
exec [dwh].[C_GetDims] 'TD Investments', 2, 1, 11
exec [dwh].[C_GetDims] 'TD London UK', 33, 1, 4
<<<<<<<<<< Test <<<<<<<<<<
*/
CREATE PROCEDURE [dbo].C_GetDims
(
