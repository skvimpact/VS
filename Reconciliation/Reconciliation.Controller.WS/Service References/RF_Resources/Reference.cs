...
namespace Reconciliation.Controller.WS.RF_Resources {
    ...
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(Reconciliation.Controller.WS.RF_Resources.ConnectionStringSettings))]
    ...
    [System.SerializableAttribute()]
    public partial class ConnectionStringSettings : Reconciliation.Controller.WS.RF_Resources.ConfigurationElement {
    ...
    public interface IRFResourceController {
        ...
        Reconciliation.Controller.WS.RF_Resources.ConnectionStringSettings GetConnectionStringSettings(string alias);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRFResourceController/GetConnectionStringSettings", ReplyAction="http://tempuri.org/IRFResourceController/GetConnectionStringSettingsResponse")]
        System.Threading.Tasks.Task<Reconciliation.Controller.WS.RF_Resources.ConnectionStringSettings> GetConnectionStringSettingsAsync(string alias);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IRFResourceControllerChannel : Reconciliation.Controller.WS.RF_Resources.IRFResourceController, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class RFResourceControllerClient : System.ServiceModel.ClientBase<Reconciliation.Controller.WS.RF_Resources.IRFResourceController>, Reconciliation.Controller.WS.RF_Resources.IRFResourceController {
        ...
        public Reconciliation.Controller.WS.RF_Resources.ConnectionStringSettings GetConnectionStringSettings(string alias) {
            return base.Channel.GetConnectionStringSettings(alias);
        }
        
        public System.Threading.Tasks.Task<Reconciliation.Controller.WS.RF_Resources.ConnectionStringSettings> GetConnectionStringSettingsAsync(string alias) {
