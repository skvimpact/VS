...
namespace Reconciliation.DAL
{
    ...
    {
        static public string getNavRusAccountList()
        {
            ...
            myStringBuilder.Append("		{[Account].[Account No].[Account No]} on 1");
            myStringBuilder.Append("	from");
            myStringBuilder.Append("		[CONS RUS]");

            return myStringBuilder.ToString();
        }

        static public string getNavRusGLInfo(int year, int month, string accountNo)
        {
            StringBuilder myStringBuilder = new StringBuilder();
            ...
            myStringBuilder.Append("(");
            myStringBuilder.Append("    [Account].[Account No].&[" + accountNo + "],");
